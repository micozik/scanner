# -*- coding: utf-8 -*-
"""
A股作战扫描器 · 云端版 V2.8（2026-07-29 台账更新：已平仓归档+电池ETF成本摊薄至0.840）
V1.7新增：
...
WATCH_STOCKS = [
    ...
    ("159796", "电池ETF汇", "持仓", 0.849, 0.790, "电池"),
...
def main():
    ...
    w("=" * 60)
    w(f"A股作战扫描器V2.8 | {bj.strftime('%Y-%m-%d %H:%M')} {weekday} | {mode}")
    w("=" * 60)
