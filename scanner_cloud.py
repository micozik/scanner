...
WATCH_STOCKS = [
    ("159796", "电池ETF汇", "持仓", 0.840, 0.790, "电池", "锂电/钠电链", 4.72),
    ("000938", "紫光股份", "持仓", 34.681, 29.48, "计算机设备", "AI算力链", 3.05),
    ("002714", "牧原股份", "持仓", 39.613, 36.50, "养殖业", "农业(独立)", 3.04),
    ("159611", "电力ETF广", "持仓", 1.080, 0.980, "电力", "电力/核电链", 1.23),
    ("603220", "中贝通信", "持仓", 18.396, 16.19, "通信服务", "AI算力链", 1.10),
    ("301269", "华大九天", "持仓", 91.999, 84.00, "软件开发", "AI算力链", 0.89),
    ("000066", "中国长城", "重点观察", 0, 0, "计算机设备", "AI算力链", 0),
    ("300308", "中际旭创", "观察·机构抄底", 0, 0, "通信设备", "AI算力链", 0),
    ("300502", "新易盛", "观察·机构抄底", 0, 0, "通信设备", "AI算力链", 0),
]
TOTAL_ASSET = 17.54   # 总资产（万元），买卖后AI更新此数
...
RECOMMENDATIONS = [
    ("2026-08-04", "603220", "中贝通信", 18.396, "B", "12周(AI算力资本开支)",
     "①北美云厂capex指引下调 ②算力租赁需求萎缩 ③通信设备板块连续3天资金流出"),
    ("2026-08-03", "159611", "电力ETF广", 1.080, "B", "12周(至10月底)",
     "①特高压招标不及预期 ②核电开工延迟 ③电网投资规划下修"),
    ...
    # ★牧原：V3.9补上逻辑破定义（此前空白=AI失职）
    ("2026-07-10", "002714", "牧原股份", 39.613, "B", "猪周期(至产能去化结束)",
     "①能繁母猪存栏连续2个月回升(去化结束) ②生猪均价跌破成本线且持续 ③政策转向压制猪价"),
]
...
STOCK_LAYER = {
    ...
    "源杰科技": ("光模块", "★上游光芯片层"), "仕佳光子": ("光模块", "★上游光芯片"),
...
def main():
    ...
    w("=" * 60)
    w(f"A股作战扫描器V4.2 | {bj.strftime('%Y-%m-%d %H:%M')} {weekday} | {mode}")
    w("=" * 60)
