...
# -*- coding: utf-8 -*-
"""
A股作战扫描器 · 云端版 V2.6（2026-07-28 修正电池ETF代码159755→159796）
V1.7新增：
...
RECOMMENDATIONS = [
    ...
    ("2026-07-27", "159796", "电池ETF汇", 0.849, "B", "5周(至9/1消费税)", "消费税取消 或 钠电订单证伪"),
...
def main():
    ...
    w("=" * 60)
    w(f"A股作战扫描器V2.6 | {bj.strftime('%Y-%m-%d %H:%M')} {weekday} | {mode}")
    w("=" * 60)
